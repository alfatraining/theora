...
static void rgb_to_yuv(png_bytep* png, th_ycbcr_buffer ycbcr, unsigned int w, unsigned int h)
{
	unsigned int x;
	unsigned int y;
...
static int png_read(const char* pathname, unsigned int* w, unsigned int* h, th_ycbcr_buffer ycbcr)
{
	FILE* fp;
