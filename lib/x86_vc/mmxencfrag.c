...
#define OC_SAD2_LOOP                                                                                                   \
	__asm {/*We want to compute (mm0+mm1>>1) on unsigned bytes without overflow, but \                                 \
...
static void oc_int_frag_copy2_mmxext(unsigned char* _dst, int _dst_ystride, const unsigned char* _src1,
