...
#define OC_COLUMN_IDCT(_y)                                                                                             \
	"#OC_COLUMN_IDCT\n" OC_IDCT_BEGIN(_y, _y) "paddw " OC_MEM_OFFS(                                                    \
		0x00,                                                                                                          \
		c) ",%%mm2\n\t"			   /*r1=H'+H'*/                                                                        \
		   "paddw %%mm1,%%mm1\n\t" /*r1=R1=A''+H'*/                                                                    \
		   "paddw %%mm2,%%mm1\n\t" /*r2=NR2*/                                                                          \
...
#define OC_J(_k, _y) OC_MEM_OFFS(((_k)-4) * 16 + 8, _y)
		OC_ROW_IDCT(y, x) OC_TRANSPOSE(y)
#undef OC_I
#undef OC_J
...
#define OC_COLUMN_IDCT_10(_y)                                                                                          \
	"#OC_COLUMN_IDCT_10\n\t" OC_IDCT_BEGIN_10(_y, _y) "paddw " OC_MEM_OFFS(                                            \
		0x00,                                                                                                          \
		c) ",%%mm2\n\t"			   /*r1=H'+H'*/                                                                        \
		   "paddw %%mm1,%%mm1\n\t" /*r1=R1=A''+H'*/                                                                    \
		   "paddw %%mm2,%%mm1\n\t" /*r2=NR2*/                                                                          \
...
#define OC_J(_k, _y) OC_MEM_OFFS(((_k)-4) * 16 + 8, _y)
		...
		OC_ROW_IDCT_10(y, x) OC_TRANSPOSE(y)
#undef OC_I
#undef OC_J
#define OC_I(_k, _y) OC_MEM_OFFS((_k)*16, _y)
#define OC_J(_k, _y) OC_I(_k, _y)
...
void oc_idct8x8_mmx(ogg_int16_t _y[64], ogg_int16_t _x[64], int _last_zzi)
{
	...
	if (_last_zzi <= 10)
		oc_idct8x8_10_mmx(_y, _x);
	else
		oc_idct8x8_slow_mmx(_y, _x);
}
