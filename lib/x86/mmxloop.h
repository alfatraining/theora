...
#define OC_LOOP_FILTER8_MMX                                                                                                                           \
	...
	"pxor %%mm6,%%mm6\n\t"                                                                                                                            \
	"pxor %%mm7,%%mm4\n\t"                                                                                                                            \
	"packuswb %%mm3,%%mm1\n\t" /*Now compute lflim of -mm4 cf. Section 7.10 of the sepc.*/ /*There's no unsigned                                      \
																							 byte+signed byte with                                    \
																							 unsigned saturation op                                   \
																							 code, so                                                 \
																							  we have to split things                                 \
																							 by sign (the other option                                \
																							 is to work in 16 bits,                                   \
																							  but working in 8 bits                                   \
																							 gives much better                                        \
																							 parallelism).                                            \
																							 We compute abs(R_i), but                                 \
																							 save a mask of which                                     \
																							 terms were negative in                                   \
																							 mm6.                                                     \
																							 Then we compute                                          \
																							 mm4=abs(lflim(R_i,L))=min(abs(R_i),max(2*L-abs(R_i),0)). \
																							 Finally, we split mm4                                    \
																							 into positive and                                        \
																							 negative pieces using the                                \
																							 mask in                                                  \
																							  mm6, and add and                                        \
																							 subtract them as                                         \
																							 appropriate.*/ /*mm4=abs(-R_i)*/ /*mm7=255-2*L*/         \
	"pcmpgtb %%mm4,%%mm6\n\t"                                                                                                                         \
	"psubb %%mm0,%%mm7\n\t"                                                                                                                           \
	"pxor %%mm6,%%mm4\n\t"                                                                                                                            \
	"psubb %%mm0,%%mm7\n\t"                                                                                                                           \
...
#define OC_LOOP_FILTER8_MMXEXT                                                                                                                                                                                                         \
	"#OC_LOOP_FILTER8_MMXEXT\n\t" /*R_i=(a_i-3*b_i+3*c_i-d_i+4>>3) has the range [-127,128], so we compute                                                                                                                             \
									 -R_i=(-a_i+3*b_i-3*c_i+d_i+3>>3) instead.*/ /*This first part is based on the                                                                                                                     \
																				   transformation                                                                                                                                      \
																					 f = -(3*(c-b)+a-d+4>>3)                                                                                                                           \
																					   =                                                                                                                                               \
																				   -(3*(c+255-b)+(a+255-d)+4-1020>>3)                                                                                                                  \
																					   ...
																					   = 128+~(3*(c+~b)+(a+~d)>>3)                                                                                                                     \
																				   (mod 256).                                                                                                                                          \
																				   Although pavgb(a,b) = (a+b+1>>1)                                                                                                                    \
																				   (biased up), we rely heavily on the                                                                                                                 \
																					fact that ~pavgb(~a,~b) = (a+b>>1)                                                                                                                 \
																				   (biased down).                                                                                                                                      \
																				   Using this, the last expression                                                                                                                     \
																				   above can be computed in 8 bits of                                                                                                                  \
																				   working                                                                                                                                             \
																					precision via:                                                                                                                                     \
																					 u = ~pavgb(~b,c);                                                                                                                                 \
																					 v = pavgb(b,~c);                                                                                                                                  \
																					 This mask is 0 or 0xFF, and                                                                                                                       \
																				   controls whether t is biased up or                                                                                                                  \
																				   down:                                                                                                                                               \
																					 m = u-v;                                                                                                                                          \
																					 t = m^pavgb(m^~a,m^d);                                                                                                                            \
																					 f = 128+pavgb(pavgb(t,u),v);                                                                                                                      \
																				   This required some careful analysis                                                                                                                 \
																				   to ensure that carries are                                                                                                                          \
																				   propagated                                                                                                                                          \
																					correctly in all cases, but has                                                                                                                    \
																				   been checked exhaustively.*/ /*input                                                                                                                \
																												   (a,                                                                                                                 \
																												   b,                                                                                                                  \
																												   c,                                                                                                                  \
																												   d,                                                                                                                  \
	...
	"movq %%mm1,%%mm4\n\t"                                                                                                                                                                                                             \
	"movq %%mm2,%%mm5\n\t"                                                                                                                                                                                                             \
	"movq (%[ll]),%%mm6\n\t" /*allocated u, v, ll, ff: (a, b, c, d, u, v, ll, ff)*/ /*u^=ff;                                                                                                                                           \
																					  v^=ff;*/                                                                                                                                         \
	"pxor %%mm7,%%mm4\n\t"                                                                                                                                                                                                             \
	"pxor %%mm7,%%mm5\n\t" /*allocated ll: (a, b, c, d, u, v, ll, ff)*/ /*u=pavgb(u,c);                                                                                                                                                \
																		  v=pavgb(v,b);*/                                                                                                                                              \
	"pavgb %%mm2,%%mm4\n\t"                                                                                                                                                                                                            \
	"pavgb %%mm1,%%mm5\n\t" /*u^=ff;                                                                                                                                                                                                   \
							  a^=ff;*/                                                                                                                                                                                                 \
	"pxor %%mm7,%%mm4\n\t"                                                                                                                                                                                                             \
	"pxor %%mm7,%%mm0\n\t"														 /*m=u-v;*/                                                                                                                                            \
	"psubb %%mm5,%%mm4\n\t" /*freed u, allocated m: (a, b, c, d, m, v, ll, ff)*/ /*a^=m;                                                                                                                                               \
																				   d^=m;*/                                                                                                                                             \
	"pxor %%mm4,%%mm0\n\t"                                                                                                                                                                                                             \
	"pxor %%mm4,%%mm3\n\t" /*t=pavgb(a,d);*/                                                                                                                                                                                           \
	"pavgb %%mm3,%%mm0\n\t"                                                                                                                                                                                                            \
	"psllw $7,%%mm7\n\t" /*freed a, d, ff, allocated t, of: (t, b, c, ., m, v, ll, of)*/ /*t^=m;                                                                                                                                       \
																						   u=m+v;*/                                                                                                                                    \
	"pxor %%mm4,%%mm0\n\t"                                                                                                                                                                                                             \
	"paddb %%mm5,%%mm4\n\t" /*freed t, m, allocated f, u: (f, b, c, ., u, v, ll, of)*/ /*f=pavgb(f,u);                                                                                                                                 \
																						 of=128;*/                                                                                                                                     \
	"pavgb %%mm4,%%mm0\n\t"                                                                                                                                                                                                            \
	"packsswb %%mm7,%%mm7\n\t" /*freed u, ff, allocated ll: (f, b, c, ., ll, v, ll, of)*/ /*f=pavgb(f,v);*/                                                                                                                            \
	"pavgb %%mm5,%%mm0\n\t"                                                                                                                                                                                                            \
	"movq %%mm7,%%mm3\n\t"                                                                                                                                                                                                             \
	"movq %%mm6,%%mm4\n\t" /*freed v, allocated of: (f, b, c, of, ll, ., ll, of)*/ /*Now compute lflim of                                                                                                                              \
																					  R_i=-(128+mm0) cf. Section 7.10                                                                                                                  \
																					  of the sepc.*/ /*There's no                                                                                                                      \
																										unsigned                                                                                                                       \
																										byte+signed                                                                                                                    \
																										byte with                                                                                                                      \
																										unsigned                                                                                                                       \
																										...
																										8 bits gives                                                                                                                   \
																										much better                                                                                                                    \
																										parallelism).*/ /*Instead of adding the offset of 128 in mm3, we use it to split mm0.                                          \
																														  This is the same number of instructions as computing a mask and splitting                                    \
																														   after the lflim computation, but has shorter dependency chains.*/ /*mm0=R_i<0?-R_i:0 (denoted abs(R_i<0))   \
