...
static const unsigned char OC_FZIG_ZAG_MMX[128] = {
	0,  8,  1,  2,  9,  16, 24, 17, 10, 3,  32, 11, 18, 25, 4,  12, 5,  26, 19, 40, 33, 34, 41, 48, 27, 6,
	13, 20, 28, 21, 14, 7,  56, 49, 42, 35, 43, 50, 57, 36, 15, 22, 29, 30, 23, 44, 37, 58, 51, 59, 38, 45,
	52, 31, 60, 53, 46, 39, 47, 54, 61, 62, 55, 63, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64,
...
void oc_state_accel_init_x86(oc_theora_state* _state)
{
	...
	if (_state->cpu_flags & OC_CPU_X86_MMXEXT)
	{
		...
		_state->opt_vtable.state_loop_filter_frag_rows = oc_state_loop_filter_frag_rows_mmxext;
	}
