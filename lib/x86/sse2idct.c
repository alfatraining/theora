...
const unsigned short __attribute__((aligned(16), used)) OC_IDCT_CONSTS[64] = {
	8,		 8,		  8,	   8,		8,		 8,		  8,	   8,		OC_C1S7, OC_C1S7, OC_C1S7, OC_C1S7, OC_C1S7,
	OC_C1S7, OC_C1S7, OC_C1S7, OC_C2S6, OC_C2S6, OC_C2S6, OC_C2S6, OC_C2S6, OC_C2S6, OC_C2S6, OC_C2S6, OC_C3S5, OC_C3S5,
	OC_C3S5, OC_C3S5, OC_C3S5, OC_C3S5, OC_C3S5, OC_C3S5, OC_C4S4, OC_C4S4, OC_C4S4, OC_C4S4, OC_C4S4, OC_C4S4, OC_C4S4,
	OC_C4S4, OC_C5S3, OC_C5S3, OC_C5S3, OC_C5S3, OC_C5S3, OC_C5S3, OC_C5S3, OC_C5S3, OC_C6S2, OC_C6S2, OC_C6S2, OC_C6S2,
	OC_C6S2, OC_C6S2, OC_C6S2, OC_C6S2, OC_C7S1, OC_C7S1, OC_C7S1, OC_C7S1, OC_C7S1, OC_C7S1, OC_C7S1, OC_C7S1};
...
#define OC_IDCT_8x8_ABC(_x)                                                                                                                                                                                      \
	"#OC_IDCT_8x8_ABC\n\t" /*Stage 1:*/ /*2-3 rotation by 6pi/16.                                                                                                                                                \
																							...
																							c) ",%%xmm4\n\t"                                                                                                     \
																							   ...
																							   "movdqa " OC_MEM_OFFS(                                                                                            \
																								   ...
																								   _x) ",%%xmm7\n\t" /*0-1 butterfly.                                                                            \
																									   ...
																									   "%%xmm6,%%"                                                                                               \
																									   "xmm4\n\t" /*Stage                                                                                        \
																													 2:*/ /*4-5 butterfly: xmm3=t[4], xmm1=t[5]                                                  \
					 ...
					 0x00, c) ",%%xmm4\n\t"                                                                            \
							  ...
							  "paddw " OC_MEM_OFFS(                                                                    \
								  ...
								  y) ",%%xmm4\n\t"                                                                     \
									 ...
									 "psraw $4,%%xmm0\n\t"                                                             \
									 "paddw %%xmm5,%%xmm2\n\t"                                                         \
									 "movdqa %%xmm0," OC_MEM_OFFS(                                                     \
										 0x00,                                                                         \
										 y) "\n\t"                                                                     \
											"psraw $4,%%xmm1\n\t"                                                      \
											"paddw %%xmm4,%%xmm3\n\t"                                                  \
											"movdqa %%xmm1," OC_MEM_OFFS(                                              \
												0x10,                                                                  \
												y) "\n\t"                                                              \
												   "psraw $4,%%xmm2\n\t"                                               \
												   "movdqa %%xmm2," OC_MEM_OFFS(                                       \
										   ...
										   0x60, x) ",%%xmm6\n\t"
													"movdqa " OC_MEM_OFFS(
														0x30, x) ",%%xmm3\n\t"
																 "movdqa " OC_MEM_OFFS(
																	 0x50, x) ",%%xmm5\n\t" OC_IDCT_8x8_ABC(x)
																	 OC_IDCT_8x8_D OC_TRANSPOSE_8x8
														   ...
														   "movdqa %%xmm1," OC_MEM_OFFS(
															   0x10, y) "\n\t"
																		"movdqa %%xmm0," OC_MEM_OFFS(
																			0x00, y) "\n\t" OC_IDCT_8x8_ABC(y)
																			OC_IDCT_8x8_D_STORE
		: [buf] "=m"(OC_ARRAY_OPERAND(ogg_int16_t, buf, 16)), [y] "=m"(OC_ARRAY_OPERAND(ogg_int16_t, _y, 64))
															 ...
															 c) ",%%mm3\n\t" /*4-7 rotation by 7pi/16.                                                      \
																...
																"movq " OC_MEM_OFFS(                                                                        \
																	...
																	c) ",%%mm4\n\t"                                                                         \
																	   ...
																	   "paddw %%mm1,%%mm7\n\t" /*0-1 butterfly.                                             \
																								 mm4=C4, mm0=X0,                                            \
																								 X4=0.*/ /*Stage 2:*/ /*4-5 butterfly: mm3=t[4], mm5=t[5]   \
																...
																"movdqa " OC_MEM_OFFS(                                                                     \
																	...
																	c) ",%%xmm4\n\t"                                                                       \
																	   ...
																	   "paddw %%xmm1,%%xmm7\n\t" /*0-1 butterfly.                                          \
																								   xmm4=C4, xmm0=X0,                                       \
																								   X4=0.*/ /*Stage                                         \
																											  2:*/ /*4-5 butterfly: xmm3=t[4], xmm5=t[5]   \
					 ...
					 "movq " OC_MEM_OFFS(
						 0x30, x) ",%%mm3\n\t"
								  "movq " OC_MEM_OFFS(
									  0x10, x) ",%%mm1\n\t"
											   "movq " OC_MEM_OFFS(
												   0x00, x) ",%%mm0\n\t" OC_IDCT_8x8_10_MMX OC_TRANSPOSE_8x4_MMX2SSE
												   OC_IDCT_8x8_10_ABC OC_IDCT_8x8_D_STORE
		: [buf] "=m"(OC_ARRAY_OPERAND(short, buf, 16)), [y] "=m"(OC_ARRAY_OPERAND(ogg_int16_t, _y, 64))
		: [x] "m" OC_CONST_ARRAY_OPERAND(ogg_int16_t, _x, 64),
		  [c] "m"(OC_CONST_ARRAY_OPERAND(ogg_int16_t, OC_IDCT_CONSTS, 128)));
	/*Clear input data for next block (decoder only).*/
	__asm__ __volatile__(
...
void oc_idct8x8_sse2(ogg_int16_t _y[64], ogg_int16_t _x[64], int _last_zzi)
{
	...
	if (_last_zzi <= 10)
		oc_idct8x8_10_sse2(_y, _x);
	else
		oc_idct8x8_slow_sse2(_y, _x);
}
