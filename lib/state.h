...
#define oc_frag_copy(_state, _dst, _src, _ystride) ((*(_state)->opt_vtable.frag_copy)(_dst, _src, _ystride))
#endif
#if !defined(oc_frag_copy_list)
#define oc_frag_copy_list(_state, _dst_frame, _src_frame, _ystride, _fragis, _nfragis, _frag_buf_offs)                 \
	((*(_state)->opt_vtable.frag_copy_list)(_dst_frame, _src_frame, _ystride, _fragis, _nfragis, _frag_buf_offs))
#endif
...
#define oc_idct8x8(_state, _y, _x, _last_zzi) ((*(_state)->opt_vtable.idct8x8)(_y, _x, _last_zzi))
#endif
#if !defined(oc_state_frag_recon)
#define oc_state_frag_recon(_state, _fragi, _pli, _dct_coeffs, _last_zzi, _dc_quant)                                   \
	((*(_state)->opt_vtable.state_frag_recon)(_state, _fragi, _pli, _dct_coeffs, _last_zzi, _dc_quant))
#endif
#if !defined(oc_loop_filter_init)
#define oc_loop_filter_init(_state, _bv, _flimit) ((*(_state)->opt_vtable.loop_filter_init)(_bv, _flimit))
#endif
#if !defined(oc_state_loop_filter_frag_rows)
#define oc_state_loop_filter_frag_rows(_state, _bv, _refi, _pli, _fragy0, _fragy_end)                                  \
	((*(_state)->opt_vtable.state_loop_filter_frag_rows)(_state, _bv, _refi, _pli, _fragy0, _fragy_end))
#endif
#if !defined(oc_restore_fpu)
#define oc_restore_fpu(_state) ((*(_state)->opt_vtable.restore_fpu)())
#endif
#else
#if !defined(oc_frag_copy)
#define oc_frag_copy(_state, _dst, _src, _ystride) oc_frag_copy_c(_dst, _src, _ystride)
#endif
#if !defined(oc_frag_copy_list)
#define oc_frag_copy_list(_state, _dst_frame, _src_frame, _ystride, _fragis, _nfragis, _frag_buf_offs)                 \
	oc_frag_copy_list_c(_dst_frame, _src_frame, _ystride, _fragis, _nfragis, _frag_buf_offs)
#endif
#if !defined(oc_frag_recon_intra)
#define oc_frag_recon_intra(_state, _dst, _dst_ystride, _residue) oc_frag_recon_intra_c(_dst, _dst_ystride, _residue)
#endif
#if !defined(oc_frag_recon_inter)
#define oc_frag_recon_inter(_state, _dst, _src, _ystride, _residue)                                                    \
...
#endif
#if !defined(oc_loop_filter_init)
#define oc_loop_filter_init(_state, _bv, _flimit) oc_loop_filter_init_c(_bv, _flimit)
#endif
#if !defined(oc_state_loop_filter_frag_rows)
...
#define OC_FRAME_FOR_MODE(_x)                                                                                          \
	OC_UNIBBLE_TABLE32(OC_FRAME_PREV, OC_FRAME_SELF, OC_FRAME_PREV, OC_FRAME_PREV, OC_FRAME_PREV, OC_FRAME_GOLD,       \
...
#define OC_MV_ADD(_mv1, _mv2) OC_MV(OC_MV_X(_mv1) + OC_MV_X(_mv2), OC_MV_Y(_mv1) + OC_MV_Y(_mv2))
#define OC_MV_SUB(_mv1, _mv2) OC_MV(OC_MV_X(_mv1) - OC_MV_X(_mv2), OC_MV_Y(_mv1) - OC_MV_Y(_mv2))
...
typedef void (*oc_state_loop_filter_frag_rows_func)(const oc_theora_state* _state, signed char _bv[256], int _refi,
...
struct oc_base_opt_vtable
{
	...
	void (*frag_copy_list)(unsigned char* _dst_frame, const unsigned char* _src_frame, int _ystride,
	...
	void (*frag_recon_inter2)(unsigned char* _dst, const unsigned char* _src1, const unsigned char* _src2, int _ystride,
							  const ogg_int16_t _residue[64]);
	void (*idct8x8)(ogg_int16_t _y[64], ogg_int16_t _x[64], int _last_zzi);
	void (*state_frag_recon)(const oc_theora_state* _state, ptrdiff_t _fragi, int _pli, ogg_int16_t _dct_coeffs[128],
...
void oc_frag_copy_list_c(unsigned char* _dst_frame, const unsigned char* _src_frame, int _ystride,
						 const ptrdiff_t* _fragis, ptrdiff_t _nfragis, const ptrdiff_t* _frag_buf_offs);
void oc_frag_recon_intra_c(unsigned char* _dst, int _dst_ystride, const ogg_int16_t _residue[64]);
void oc_frag_recon_inter_c(unsigned char* _dst, const unsigned char* _src, int _ystride,
						   const ogg_int16_t _residue[64]);
void oc_frag_recon_inter2_c(unsigned char* _dst, const unsigned char* _src1, const unsigned char* _src2, int _ystride,
							const ogg_int16_t _residue[64]);
...
void oc_state_frag_recon_c(const oc_theora_state* _state, ptrdiff_t _fragi, int _pli, ogg_int16_t _dct_coeffs[128],
						   int _last_zzi, ogg_uint16_t _dc_quant);
void oc_state_loop_filter_frag_rows_c(const oc_theora_state* _state, signed char _bv[256], int _refi, int _pli,
