...
#define oc_enc_frag_sub(_enc, _diff, _src, _ref, _ystride) ((*(_enc)->opt_vtable.frag_sub)(_diff, _src, _ref, _ystride))
#endif
#if !defined(oc_enc_frag_sub_128)
#define oc_enc_frag_sub_128(_enc, _diff, _src, _ystride) ((*(_enc)->opt_vtable.frag_sub_128)(_diff, _src, _ystride))
#endif
#if !defined(oc_enc_frag_sad)
#define oc_enc_frag_sad(_enc, _src, _ref, _ystride) ((*(_enc)->opt_vtable.frag_sad)(_src, _ref, _ystride))
#endif
...
#define oc_enc_frag_intra_sad(_enc, _src, _ystride) ((*(_enc)->opt_vtable.frag_intra_sad)(_src, _ystride))
#endif
#if !defined(oc_enc_frag_satd)
#define oc_enc_frag_satd(_enc, _dc, _src, _ref, _ystride) ((*(_enc)->opt_vtable.frag_satd)(_dc, _src, _ref, _ystride))
#endif
...
#define oc_enc_frag_intra_satd(_enc, _dc, _src, _ystride) ((*(_enc)->opt_vtable.frag_intra_satd)(_dc, _src, _ystride))
#endif
#if !defined(oc_enc_frag_ssd)
#define oc_enc_frag_ssd(_enc, _src, _ref, _ystride) ((*(_enc)->opt_vtable.frag_ssd)(_src, _ref, _ystride))
#endif
...
#define oc_enc_enquant_table_fixup(_enc, _enquant, _nqis) ((*(_enc)->opt_vtable.enquant_table_fixup)(_enquant, _nqis))
#endif
...
#define oc_enc_fdct8x8(_enc, _y, _x) ((*(_enc)->opt_vtable.fdct8x8)(_y, _x))
#endif
#else
#if !defined(oc_enc_frag_sub)
#define oc_enc_frag_sub(_enc, _diff, _src, _ref, _ystride) oc_enc_frag_sub_c(_diff, _src, _ref, _ystride)
#endif
#if !defined(oc_enc_frag_sub_128)
#define oc_enc_frag_sub_128(_enc, _diff, _src, _ystride) oc_enc_frag_sub_128_c(_diff, _src, _ystride)
#endif
#if !defined(oc_enc_frag_sad)
#define oc_enc_frag_sad(_enc, _src, _ref, _ystride) oc_enc_frag_sad_c(_src, _ref, _ystride)
#endif
#if !defined(oc_enc_frag_sad_thresh)
#define oc_enc_frag_sad_thresh(_enc, _src, _ref, _ystride, _thresh)                                                    \
...
#endif
#if !defined(oc_enc_frag_intra_sad)
#define oc_enc_frag_intra_sad(_enc, _src, _ystride) oc_enc_frag_intra_sad_c(_src, _ystride)
#endif
#if !defined(oc_enc_frag_satd)
#define oc_enc_frag_satd(_enc, _dc, _src, _ref, _ystride) oc_enc_frag_satd_c(_dc, _src, _ref, _ystride)
#endif
#if !defined(oc_enc_frag_satd2)
#define oc_enc_frag_satd2(_enc, _dc, _src, _ref1, _ref2, _ystride)                                                     \
...
#endif
#if !defined(oc_enc_frag_intra_satd)
#define oc_enc_frag_intra_satd(_enc, _dc, _src, _ystride) oc_enc_frag_intra_satd_c(_dc, _src, _ystride)
#endif
#if !defined(oc_enc_frag_ssd)
#define oc_enc_frag_ssd(_enc, _src, _ref, _ystride) oc_enc_frag_ssd_c(_src, _ref, _ystride)
#endif
#if !defined(oc_enc_frag_border_ssd)
#define oc_enc_frag_border_ssd(_enc, _src, _ref, _ystride, _mask) oc_enc_frag_border_ssd_c(_src, _ref, _ystride, _mask)
#endif
#if !defined(oc_enc_frag_copy2)
#define oc_enc_frag_copy2(_enc, _dst, _src1, _src2, _ystride) oc_enc_frag_copy2_c(_dst, _src1, _src2, _ystride)
#endif
#if !defined(oc_enc_enquant_table_init)
#define oc_enc_enquant_table_init(_enc, _enquant, _dequant) oc_enc_enquant_table_init_c(_enquant, _dequant)
#endif
#if !defined(oc_enc_enquant_table_fixup)
#define oc_enc_enquant_table_fixup(_enc, _enquant, _nqis) oc_enc_enquant_table_fixup_c(_enquant, _nqis)
#endif
#if !defined(oc_enc_quantize)
#define oc_enc_quantize(_enc, _qdct, _dct, _dequant, _enquant) oc_enc_quantize_c(_qdct, _dct, _dequant, _enquant)
#endif
#if !defined(oc_enc_frag_recon_intra)
#define oc_enc_frag_recon_intra(_enc, _dst, _ystride, _residue) oc_frag_recon_intra_c(_dst, _ystride, _residue)
#endif
#if !defined(oc_enc_frag_recon_inter)
#define oc_enc_frag_recon_inter(_enc, _dst, _src, _ystride, _residue)                                                  \
...
#define OC_RD_SCALE(_ssd, _rd_scale)                                                                                   \
	((unsigned)((unsigned long)(_ssd) * (_rd_scale) + ((1 << OC_RD_SCALE_BITS) >> 1) >> OC_RD_SCALE_BITS))
#else
#define OC_RD_SCALE(_ssd, _rd_scale)                                                                                   \
	(((_ssd) >> OC_RD_SCALE_BITS) * (_rd_scale) +                                                                      \
	 (((_ssd) & (1 << OC_RD_SCALE_BITS) - 1) * (_rd_scale) + ((1 << OC_RD_SCALE_BITS) >> 1) >> OC_RD_SCALE_BITS))
#endif
...
struct oc_enc_opt_vtable
{
	...
	unsigned (*frag_sad2_thresh)(const unsigned char* _src, const unsigned char* _ref1, const unsigned char* _ref2,
								 int _ystride, unsigned _thresh);
	unsigned (*frag_intra_sad)(const unsigned char* _src, int _ystride);
	unsigned (*frag_satd)(int* _dc, const unsigned char* _src, const unsigned char* _ref, int _ystride);
	unsigned (*frag_satd2)(int* _dc, const unsigned char* _src, const unsigned char* _ref1, const unsigned char* _ref2,
						   int _ystride);
	unsigned (*frag_intra_satd)(int* _dc, const unsigned char* _src, int _ystride);
	unsigned (*frag_ssd)(const unsigned char* _src, const unsigned char* _ref, int _ystride);
	unsigned (*frag_border_ssd)(const unsigned char* _src, const unsigned char* _ref, int _ystride, ogg_int64_t _mask);
	void (*frag_copy2)(unsigned char* _dst, const unsigned char* _src1, const unsigned char* _src2, int _ystride);
	void (*enquant_table_init)(void* _enquant, const ogg_uint16_t _dequant[64]);
	void (*enquant_table_fixup)(void* _enquant[3][3][2], int _nqis);
	int (*quantize)(ogg_int16_t _qdct[64], const ogg_int16_t _dct[64], const ogg_uint16_t _dequant[64],
					const void* _enquant);
	void (*frag_recon_intra)(unsigned char* _dst, int _ystride, const ogg_int16_t _residue[64]);
	void (*frag_recon_inter)(unsigned char* _dst, const unsigned char* _src, int _ystride,
...
int oc_enc_tokenize_ac(oc_enc_ctx* _enc, int _pli, ptrdiff_t _fragi, ogg_int16_t* _qdct_out,
					   const ogg_int16_t* _qdct_in, const ogg_uint16_t* _dequant, const ogg_int16_t* _dct, int _zzi,
					   oc_token_checkpoint** _stack, int _lambda, int _acmin);
int oc_enc_tokenize_ac_fast(oc_enc_ctx* _enc, int _pli, ptrdiff_t _fragi, ogg_int16_t* _qdct_out,
							const ogg_int16_t* _qdct_in, const ogg_uint16_t* _dequant, const ogg_int16_t* _dct,
...
void oc_enc_tokenize_dc_frag_list(oc_enc_ctx* _enc, int _pli, const ptrdiff_t* _coded_fragis, ptrdiff_t _ncoded_fragis,
...
int oc_state_flushheader(oc_theora_state* _state, int* _packet_state, oggpack_buffer* _opb, const th_quant_info* _qinfo,
						 const th_huff_code _codes[TH_NHUFFMAN_TABLES][TH_NDCT_TOKENS], const char* _vendor,
						 th_comment* _tc, ogg_packet* _op);
...
unsigned oc_enc_frag_sad2_thresh_c(const unsigned char* _src, const unsigned char* _ref1, const unsigned char* _ref2,
								   int _ystride, unsigned _thresh);
unsigned oc_enc_frag_intra_sad_c(const unsigned char* _src, int _ystride);
unsigned oc_enc_frag_satd_c(int* _dc, const unsigned char* _src, const unsigned char* _ref, int _ystride);
unsigned oc_enc_frag_satd2_c(int* _dc, const unsigned char* _src, const unsigned char* _ref1,
							 const unsigned char* _ref2, int _ystride);
unsigned oc_enc_frag_intra_satd_c(int* _dc, const unsigned char* _src, int _ystride);
unsigned oc_enc_frag_ssd_c(const unsigned char* _src, const unsigned char* _ref, int _ystride);
unsigned oc_enc_frag_border_ssd_c(const unsigned char* _src, const unsigned char* _ref, int _ystride,
								  ogg_int64_t _mask);
void oc_enc_frag_copy2_c(unsigned char* _dst, const unsigned char* _src1, const unsigned char* _src2, int _ystride);
void oc_enc_enquant_table_init_c(void* _enquant, const ogg_uint16_t _dequant[64]);
void oc_enc_enquant_table_fixup_c(void* _enquant[3][3][2], int _nqis);
int oc_enc_quantize_c(ogg_int16_t _qdct[64], const ogg_int16_t _dct[64], const ogg_uint16_t _dequant[64],
					  const void* _enquant);
