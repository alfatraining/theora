...
#if !defined(OC_ARM_ASM) || !defined(OC_ARM_ASM_EDSP) && !defined(OC_ARM_ASM_MEDIA) && !defined(OC_ARM_ASM_NEON)
ogg_uint32_t oc_cpu_flags_get(void) { return 0; }
...
/*MSVC has no inline __asm support for ARM, but it does let you __emit
  ...
  All of these instructions should be essentially nops.*/
	...
	__except(GetExceptionCode() == EXCEPTION_ILLEGAL_INSTRUCTION) { /*Ignore exception.*/ }
