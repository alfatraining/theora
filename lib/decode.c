...
static const unsigned char OC_MODE_ALPHABETS[7][OC_NMODES] = {
	/*Last MV dominates */
	{OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV_LAST2, OC_MODE_INTER_MV, OC_MODE_INTER_NOMV, OC_MODE_INTRA,
	 OC_MODE_GOLDEN_NOMV, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR},
	{OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV_LAST2, OC_MODE_INTER_NOMV, OC_MODE_INTER_MV, OC_MODE_INTRA,
	 OC_MODE_GOLDEN_NOMV, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR},
	{OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV, OC_MODE_INTER_MV_LAST2, OC_MODE_INTER_NOMV, OC_MODE_INTRA,
	 OC_MODE_GOLDEN_NOMV, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR},
	{OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV, OC_MODE_INTER_NOMV, OC_MODE_INTER_MV_LAST2, OC_MODE_INTRA,
	 OC_MODE_GOLDEN_NOMV, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR},
	/*No MV dominates.*/
	{OC_MODE_INTER_NOMV, OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV_LAST2, OC_MODE_INTER_MV, OC_MODE_INTRA,
	 OC_MODE_GOLDEN_NOMV, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR},
	{OC_MODE_INTER_NOMV, OC_MODE_GOLDEN_NOMV, OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV_LAST2, OC_MODE_INTER_MV,
	 OC_MODE_INTRA, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR},
	/*Default ordering.*/
	{OC_MODE_INTER_NOMV, OC_MODE_INTRA, OC_MODE_INTER_MV, OC_MODE_INTER_MV_LAST, OC_MODE_INTER_MV_LAST2,
	 OC_MODE_GOLDEN_NOMV, OC_MODE_GOLDEN_MV, OC_MODE_INTER_MV_FOUR}};
...
/*The number of additional extra bits that are decoded with each of the
   internal DCT tokens.*/
static const unsigned char OC_INTERNAL_DCT_TOKEN_EXTRA_BITS[15] = {12, 4, 3, 3, 4, 4, 5, 5, 8, 8, 8, 8, 3, 3, 6};

/*Whether or not an internal token needs any additional extra bits.*/
#define OC_DCT_TOKEN_NEEDS_MORE(token)                                                                                 \
	(token < (int)(sizeof(OC_INTERNAL_DCT_TOKEN_EXTRA_BITS) / sizeof(*OC_INTERNAL_DCT_TOKEN_EXTRA_BITS)))
...
#define OC_DCT_CW_PACK(_eobs, _rlen, _mag, _flip)                                                                      \
	((_eobs) << OC_DCT_CW_EOB_SHIFT | (_rlen) << OC_DCT_CW_RLEN_SHIFT | (_flip) << OC_DCT_CW_FLIP_BIT |                \
...
static const ogg_int32_t OC_DCT_CODE_WORD[92] = {
	...
	OC_DCT_CW_PACK(0, 0, 13, 0), OC_DCT_CW_PACK(0, 0, 13, 1),
	/*OC_DCT_VAL_CAT6 (5 extra bits-1 already read)*/
	OC_DCT_CW_PACK(0, 0, 21, 0), OC_DCT_CW_PACK(0, 0, 21, 1),
	/*OC_DCT_VAL_CAT7 (6 extra bits-1 already read)*/
	OC_DCT_CW_PACK(0, 0, 37, 0), OC_DCT_CW_PACK(0, 0, 37, 1),
	/*OC_DCT_VAL_CAT8 (10 extra bits-2 already read)*/
	OC_DCT_CW_PACK(0, 0, 69, 0), OC_DCT_CW_PACK(0, 0, 325, 0), OC_DCT_CW_PACK(0, 0, 69, 1),
	...
	OC_DCT_CW_PACK(0, 10, +1, 0), OC_DCT_CW_PACK(0, 10, -1, 0),
	...
	OC_DCT_CW_PACK(0, 1, +1, 0), OC_DCT_CW_PACK(0, 1, -1, 0), OC_DCT_CW_PACK(0, 2, +1, 0), OC_DCT_CW_PACK(0, 2, -1, 0),
	OC_DCT_CW_PACK(0, 3, +1, 0), OC_DCT_CW_PACK(0, 3, -1, 0), OC_DCT_CW_PACK(0, 4, +1, 0), OC_DCT_CW_PACK(0, 4, -1, 0),
	OC_DCT_CW_PACK(0, 5, +1, 0), OC_DCT_CW_PACK(0, 5, -1, 0),
	/*OC_DCT_RUN_CAT2A (2 extra bits-2 already read)*/
	OC_DCT_CW_PACK(0, 1, +2, 0), OC_DCT_CW_PACK(0, 1, +3, 0), OC_DCT_CW_PACK(0, 1, -2, 0), OC_DCT_CW_PACK(0, 1, -3, 0),
	/*OC_DCT_RUN_CAT1B (3 extra bits-3 already read)*/
	OC_DCT_CW_PACK(0, 6, +1, 0), OC_DCT_CW_PACK(0, 7, +1, 0), OC_DCT_CW_PACK(0, 8, +1, 0), OC_DCT_CW_PACK(0, 9, +1, 0),
	OC_DCT_CW_PACK(0, 6, -1, 0), OC_DCT_CW_PACK(0, 7, -1, 0), OC_DCT_CW_PACK(0, 8, -1, 0), OC_DCT_CW_PACK(0, 9, -1, 0),
	/*OC_DCT_RUN_CAT2B (3 extra bits-3 already read)*/
	OC_DCT_CW_PACK(0, 2, +2, 0), OC_DCT_CW_PACK(0, 3, +2, 0), OC_DCT_CW_PACK(0, 2, +3, 0), OC_DCT_CW_PACK(0, 3, +3, 0),
	OC_DCT_CW_PACK(0, 2, -2, 0), OC_DCT_CW_PACK(0, 3, -2, 0), OC_DCT_CW_PACK(0, 2, -3, 0), OC_DCT_CW_PACK(0, 3, -3, 0),
	/*OC_DCT_SHORT_ZRL_TOKEN (3 extra bits-3 already read)
	  Flip is set on the first one to distinguish it from OC_DCT_CW_FINISH.*/
	OC_DCT_CW_PACK(0, 0, 0, 1), OC_DCT_CW_PACK(0, 1, 0, 0), OC_DCT_CW_PACK(0, 2, 0, 0), OC_DCT_CW_PACK(0, 3, 0, 0),
	OC_DCT_CW_PACK(0, 4, 0, 0), OC_DCT_CW_PACK(0, 5, 0, 0), OC_DCT_CW_PACK(0, 6, 0, 0), OC_DCT_CW_PACK(0, 7, 0, 0),
	...
	OC_DCT_CW_PACK(0, 0, +3, 0), OC_DCT_CW_PACK(0, 0, -3, 0), OC_DCT_CW_PACK(0, 0, +4, 0), OC_DCT_CW_PACK(0, 0, -4, 0),
	OC_DCT_CW_PACK(0, 0, +5, 0), OC_DCT_CW_PACK(0, 0, -5, 0), OC_DCT_CW_PACK(0, 0, +6, 0), OC_DCT_CW_PACK(0, 0, -6, 0),
	/*OC_DCT_VAL_CAT3 (2 extra bits-2 already read)*/
	OC_DCT_CW_PACK(0, 0, +7, 0), OC_DCT_CW_PACK(0, 0, +8, 0), OC_DCT_CW_PACK(0, 0, -7, 0), OC_DCT_CW_PACK(0, 0, -8, 0),
	/*OC_DCT_VAL_CAT4 (3 extra bits-3 already read)*/
	OC_DCT_CW_PACK(0, 0, +9, 0), OC_DCT_CW_PACK(0, 0, +10, 0), OC_DCT_CW_PACK(0, 0, +11, 0),
	OC_DCT_CW_PACK(0, 0, +12, 0), OC_DCT_CW_PACK(0, 0, -9, 0), OC_DCT_CW_PACK(0, 0, -10, 0),
	OC_DCT_CW_PACK(0, 0, -11, 0), OC_DCT_CW_PACK(0, 0, -12, 0),
	/*OC_DCT_REPEAT_RUN1_TOKEN (3 extra bits-3 already read)*/
	OC_DCT_CW_PACK(8, 0, 0, 0), OC_DCT_CW_PACK(9, 0, 0, 0), OC_DCT_CW_PACK(10, 0, 0, 0), OC_DCT_CW_PACK(11, 0, 0, 0),
	OC_DCT_CW_PACK(12, 0, 0, 0), OC_DCT_CW_PACK(13, 0, 0, 0), OC_DCT_CW_PACK(14, 0, 0, 0), OC_DCT_CW_PACK(15, 0, 0, 0),
	/*OC_DCT_REPEAT_RUN0_TOKEN (2 extra bits-2 already read)*/
	OC_DCT_CW_PACK(4, 0, 0, 0), OC_DCT_CW_PACK(5, 0, 0, 0), OC_DCT_CW_PACK(6, 0, 0, 0), OC_DCT_CW_PACK(7, 0, 0, 0),
};
...
static int oc_sb_run_unpack(oc_pack_buf* _opb)
{
	...
	static const ogg_int16_t OC_SB_RUN_TREE[22] = {
		4, -(1 << 8 | 1), -(1 << 8 | 1), -(1 << 8 | 1), -(1 << 8 | 1), -(1 << 8 | 1), -(1 << 8 | 1), -(1 << 8 | 1),
		-(1 << 8 | 1), -(3 << 8 | 2), -(3 << 8 | 2), -(3 << 8 | 3), -(3 << 8 | 3), -(4 << 8 | 4), -(4 << 8 | 5),
		-(4 << 8 | 2 << 4 | 6 - 6), 17, 2, -(2 << 8 | 2 << 4 | 10 - 6), -(2 << 8 | 2 << 4 | 14 - 6),
		-(2 << 8 | 4 << 4 | 18 - 6), -(2 << 8 | 12 << 4 | 34 - 6)};
	int ret;
...
static int oc_block_run_unpack(oc_pack_buf* _opb)
{
	...
	static const ogg_int16_t OC_BLOCK_RUN_TREE[61] = {
		5, -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1),
		-(2 << 8 | 1), -(2 << 8 | 2), -(2 << 8 | 2), -(2 << 8 | 2), -(2 << 8 | 2), -(2 << 8 | 2), -(2 << 8 | 2),
		-(2 << 8 | 2), -(2 << 8 | 2), -(3 << 8 | 3), -(3 << 8 | 3), -(3 << 8 | 3), -(3 << 8 | 3), -(3 << 8 | 4),
		-(3 << 8 | 4), -(3 << 8 | 4), -(3 << 8 | 4), -(4 << 8 | 5), -(4 << 8 | 5), -(4 << 8 | 6), -(4 << 8 | 6), 33, 36,
		39, 44, 1, -(1 << 8 | 7), -(1 << 8 | 8), 1, -(1 << 8 | 9), -(1 << 8 | 10), 2, -(2 << 8 | 11), -(2 << 8 | 12),
		-(2 << 8 | 13), -(2 << 8 | 14), 4, -(4 << 8 | 15), -(4 << 8 | 16), -(4 << 8 | 17), -(4 << 8 | 18),
		-(4 << 8 | 19), -(4 << 8 | 20), -(4 << 8 | 21), -(4 << 8 | 22), -(4 << 8 | 23), -(4 << 8 | 24), -(4 << 8 | 25),
		-(4 << 8 | 26), -(4 << 8 | 27), -(4 << 8 | 28), -(4 << 8 | 29), -(4 << 8 | 30)};
...
static int oc_dec_init(oc_dec_ctx* _dec, const th_info* _info, const th_setup_info* _setup)
{
	int qti;
	int pli;
	int qi;
	...
	if (ret < 0)
		return ret;
	ret = oc_huff_trees_copy(_dec->huff_tables, (const ogg_int16_t* const*)_setup->huff_tables);
	if (ret < 0)
	{
	...
	/*For each fragment, allocate one byte for every DCT coefficient token, plus
	   ...
	   one.*/
	_dec->dct_tokens = (unsigned char*)_ogg_malloc((64 + 64 + 1) * _dec->state.nfrags * sizeof(_dec->dct_tokens[0]));
	...
	for (qi = 0; qi < 64; qi++)
		for (pli = 0; pli < 3; pli++)
			for (qti = 0; qti < 2; qti++)
			{
				_dec->state.dequant_tables[qi][pli][qti] = _dec->state.dequant_table_data[qi][pli][qti];
			}
	oc_dequant_tables_init(_dec->state.dequant_tables, _dec->pp_dc_scale, &_setup->qinfo);
	for (qi = 0; qi < 64; qi++)
	{
		int qsum;
		qsum = 0;
		for (qti = 0; qti < 2; qti++)
			for (pli = 0; pli < 3; pli++)
			{
				qsum += _dec->state.dequant_tables[qi][pli][qti][12] + _dec->state.dequant_tables[qi][pli][qti][17] +
							_dec->state.dequant_tables[qi][pli][qti][18] + _dec->state.dequant_tables[qi][pli][qti][24]
						<< (pli == 0);
			}
		_dec->pp_sharp_mod[qi] = -(qsum >> 11);
	}
	memcpy(_dec->state.loop_filter_limits, _setup->qinfo.loop_filter_limits, sizeof(_dec->state.loop_filter_limits));
		...
		for (; sbi < nsbs; sbi++)
		{
			...
			for (quadi = 0; quadi < 4; quadi++)
				if (sb_flags[sbi].quad_valid & 1 << quadi)
				{
					...
					if (!pli)
						mb_modes[sbi << 2 | quadi] = quad_coded;
				}
		}
		_dec->state.ncoded_fragis[pli] = ncoded_fragis - prev_ncoded_fragis;
		prev_ncoded_fragis = ncoded_fragis;
...
static const ogg_int16_t OC_VLC_MODE_TREE[26] = {
	4, -(1 << 8 | 0), -(1 << 8 | 0), -(1 << 8 | 0), -(1 << 8 | 0), -(1 << 8 | 0), -(1 << 8 | 0), -(1 << 8 | 0),
	-(1 << 8 | 0), -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1), -(2 << 8 | 1), -(3 << 8 | 2), -(3 << 8 | 2),
	-(4 << 8 | 3), 17, 3, -(1 << 8 | 4), -(1 << 8 | 4), -(1 << 8 | 4), -(1 << 8 | 4), -(2 << 8 | 5), -(2 << 8 | 5),
	-(3 << 8 | 6), -(3 << 8 | 7)};

static const ogg_int16_t OC_CLC_MODE_TREE[9] = {3, -(3 << 8 | 0), -(3 << 8 | 1), -(3 << 8 | 2), -(3 << 8 | 3),
...
static const ogg_int16_t OC_VLC_MV_COMP_TREE[101] = {
	5, -(3 << 8 | 32 + 0), -(3 << 8 | 32 + 0), -(3 << 8 | 32 + 0), -(3 << 8 | 32 + 0), -(3 << 8 | 32 + 1),
	-(3 << 8 | 32 + 1), -(3 << 8 | 32 + 1), -(3 << 8 | 32 + 1), -(3 << 8 | 32 - 1), -(3 << 8 | 32 - 1),
	-(3 << 8 | 32 - 1), -(3 << 8 | 32 - 1), -(4 << 8 | 32 + 2), -(4 << 8 | 32 + 2), -(4 << 8 | 32 - 2),
	-(4 << 8 | 32 - 2), -(4 << 8 | 32 + 3), -(4 << 8 | 32 + 3), -(4 << 8 | 32 - 3), -(4 << 8 | 32 - 3), 33, 36, 39, 42,
	45, 50, 55, 60, 65, 74, 83, 92, 1, -(1 << 8 | 32 + 4), -(1 << 8 | 32 - 4), 1, -(1 << 8 | 32 + 5),
	-(1 << 8 | 32 - 5), 1, -(1 << 8 | 32 + 6), -(1 << 8 | 32 - 6), 1, -(1 << 8 | 32 + 7), -(1 << 8 | 32 - 7), 2,
	-(2 << 8 | 32 + 8), -(2 << 8 | 32 - 8), -(2 << 8 | 32 + 9), -(2 << 8 | 32 - 9), 2, -(2 << 8 | 32 + 10),
	-(2 << 8 | 32 - 10), -(2 << 8 | 32 + 11), -(2 << 8 | 32 - 11), 2, -(2 << 8 | 32 + 12), -(2 << 8 | 32 - 12),
	-(2 << 8 | 32 + 13), -(2 << 8 | 32 - 13), 2, -(2 << 8 | 32 + 14), -(2 << 8 | 32 - 14), -(2 << 8 | 32 + 15),
	-(2 << 8 | 32 - 15), 3, -(3 << 8 | 32 + 16), -(3 << 8 | 32 - 16), -(3 << 8 | 32 + 17), -(3 << 8 | 32 - 17),
	-(3 << 8 | 32 + 18), -(3 << 8 | 32 - 18), -(3 << 8 | 32 + 19), -(3 << 8 | 32 - 19), 3, -(3 << 8 | 32 + 20),
	-(3 << 8 | 32 - 20), -(3 << 8 | 32 + 21), -(3 << 8 | 32 - 21), -(3 << 8 | 32 + 22), -(3 << 8 | 32 - 22),
	-(3 << 8 | 32 + 23), -(3 << 8 | 32 - 23), 3, -(3 << 8 | 32 + 24), -(3 << 8 | 32 - 24), -(3 << 8 | 32 + 25),
	-(3 << 8 | 32 - 25), -(3 << 8 | 32 + 26), -(3 << 8 | 32 - 26), -(3 << 8 | 32 + 27), -(3 << 8 | 32 - 27), 3,
	-(3 << 8 | 32 + 28), -(3 << 8 | 32 - 28), -(3 << 8 | 32 + 29), -(3 << 8 | 32 - 29), -(3 << 8 | 32 + 30),
	-(3 << 8 | 32 - 30), -(3 << 8 | 32 + 31), -(3 << 8 | 32 - 31)};

static const ogg_int16_t OC_CLC_MV_COMP_TREE[65] = {
	6, -(6 << 8 | 32 + 0), -(6 << 8 | 32 - 0), -(6 << 8 | 32 + 1), -(6 << 8 | 32 - 1), -(6 << 8 | 32 + 2),
	-(6 << 8 | 32 - 2), -(6 << 8 | 32 + 3), -(6 << 8 | 32 - 3), -(6 << 8 | 32 + 4), -(6 << 8 | 32 - 4),
	-(6 << 8 | 32 + 5), -(6 << 8 | 32 - 5), -(6 << 8 | 32 + 6), -(6 << 8 | 32 - 6), -(6 << 8 | 32 + 7),
	-(6 << 8 | 32 - 7), -(6 << 8 | 32 + 8), -(6 << 8 | 32 - 8), -(6 << 8 | 32 + 9), -(6 << 8 | 32 - 9),
	-(6 << 8 | 32 + 10), -(6 << 8 | 32 - 10), -(6 << 8 | 32 + 11), -(6 << 8 | 32 - 11), -(6 << 8 | 32 + 12),
	-(6 << 8 | 32 - 12), -(6 << 8 | 32 + 13), -(6 << 8 | 32 - 13), -(6 << 8 | 32 + 14), -(6 << 8 | 32 - 14),
	-(6 << 8 | 32 + 15), -(6 << 8 | 32 - 15), -(6 << 8 | 32 + 16), -(6 << 8 | 32 - 16), -(6 << 8 | 32 + 17),
	-(6 << 8 | 32 - 17), -(6 << 8 | 32 + 18), -(6 << 8 | 32 - 18), -(6 << 8 | 32 + 19), -(6 << 8 | 32 - 19),
	-(6 << 8 | 32 + 20), -(6 << 8 | 32 - 20), -(6 << 8 | 32 + 21), -(6 << 8 | 32 - 21), -(6 << 8 | 32 + 22),
	-(6 << 8 | 32 - 22), -(6 << 8 | 32 + 23), -(6 << 8 | 32 - 23), -(6 << 8 | 32 + 24), -(6 << 8 | 32 - 24),
	-(6 << 8 | 32 + 25), -(6 << 8 | 32 - 25), -(6 << 8 | 32 + 26), -(6 << 8 | 32 - 26), -(6 << 8 | 32 + 27),
	-(6 << 8 | 32 - 27), -(6 << 8 | 32 + 28), -(6 << 8 | 32 - 28), -(6 << 8 | 32 + 29), -(6 << 8 | 32 - 29),
...
static ptrdiff_t oc_dec_dc_coeff_unpack(oc_dec_ctx* _dec, int _huff_idxs[2], ptrdiff_t _ntoks_left[3][64])
{
	...
	for (pli = 0; pli < 3; pli++)
	{
		...
		while (fragii < ncoded_fragis)
		{
			...
			int eb;
			int skip;
			token = oc_huff_token_decode(&_dec->opb, _dec->huff_tables[_huff_idxs[pli + 1 >> 1]]);
			dct_tokens[ti++] = (unsigned char)token;
			if (OC_DCT_TOKEN_NEEDS_MORE(token))
			{
				eb = (int)oc_pack_read(&_dec->opb, OC_INTERNAL_DCT_TOKEN_EXTRA_BITS[token]);
...
/*Unpacks the AC coefficient tokens.
  ...
  _eobs:       The length of any outstanding EOB run from previous
				coefficients.
  Return: The length of any outstanding EOB run.*/
static int oc_dec_ac_coeff_unpack(oc_dec_ctx* _dec, int _zzi, int _huff_idxs[2], ptrdiff_t _ntoks_left[3][64],
								  ptrdiff_t _eobs)
{
	unsigned char* dct_tokens;
	ptrdiff_t ti;
...
static int oc_dec_postprocess_init(oc_dec_ctx* _dec)
{
	...
	if (_dec->dc_qis == NULL)
	{
		...
		if (_dec->state.frame_type != OC_INTRA_FRAME)
			return 1;
		_dec->dc_qis = (unsigned char*)_ogg_malloc(_dec->state.nfrags * sizeof(_dec->dc_qis[0]));
		if (_dec->dc_qis == NULL)
			return 1;
	...
	else
	{
		...
		dc_qis = _dec->dc_qis;
		coded_fragis = _dec->state.coded_fragis;
		ncoded_fragis = _dec->state.ncoded_fragis[0] + _dec->state.ncoded_fragis[1] + _dec->state.ncoded_fragis[2];
	...
	if (_dec->variances == NULL)
	{
		...
		frame_sz += c_sz << 1;
		_dec->pp_frame_data = (unsigned char*)_ogg_malloc(frame_sz * sizeof(_dec->pp_frame_data[0]));
		_dec->variances = (int*)_ogg_malloc(_dec->state.nfrags * sizeof(_dec->variances[0]));
	...
	if (_dec->pp_frame_state != 1 + (_dec->pp_level >= OC_PP_LEVEL_DEBLOCKC))
	{
		if (_dec->pp_level < OC_PP_LEVEL_DEBLOCKC)
		{
			...
			_dec->pp_frame_buf[0].data =
				_dec->pp_frame_data + (1 - _dec->pp_frame_buf[0].height) * (ptrdiff_t)_dec->pp_frame_buf[0].stride;
		}
		else
		{
			size_t y_sz;
	...
	if (_dec->pp_level < OC_PP_LEVEL_DEBLOCKC)
	{
		memcpy(_dec->pp_frame_buf + 1, _dec->state.ref_frame_bufs[_dec->state.ref_frame_idx[OC_FRAME_SELF]] + 1,
...
static void oc_dec_pipeline_init(oc_dec_ctx* _dec, oc_dec_pipeline_state* _pipe)
{
	const ptrdiff_t* coded_fragis;
	...
	for (pli = 0; pli < 3; pli++)
	{
		for (qii = 0; qii < _dec->state.nqis; qii++)
		{
			for (qti = 0; qti < 2; qti++)
			{
				_pipe->dequant[pli][qii][qti] = _dec->state.dequant_tables[_dec->state.qis[qii]][pli][qti];
			}
		}
	}
	...
	if (flimit != 0)
		oc_loop_filter_init(&_dec->state, _pipe->bounding_values, flimit);
	...
	else
	{
		...
		memcpy(_dec->pp_frame_buf, _dec->state.ref_frame_bufs[_dec->state.ref_frame_idx[OC_FRAME_SELF]],
			   sizeof(_dec->pp_frame_buf[0]) * 3);
	}
	/*Clear down the DCT coefficient buffer for the first block.*/
	for (zzi = 0; zzi < 64; zzi++)
		_pipe->dct_coeffs[zzi] = 0;
}
...
void oc_dec_dc_unpredict_mcu_plane_c(oc_dec_ctx* _dec, oc_dec_pipeline_state* _pipe, int _pli)
{
		...
		else
		{
			...
			for (fragx = 0; fragx < nhfrags; fragx++, fragi++)
			{
				...
				if (frags[fragi].coded)
				{
					...
					switch ((l_ref == refi) | (ul_ref == refi) << 1 | (u_ref == refi) << 2 | (ur_ref == refi) << 3)
					{
						default:
							pred = pred_last[refi];
							break;
	...
	_pipe->nuncoded_fragis[_pli] = (fragy_end - fragy0) * (ptrdiff_t)nhfrags - ncoded_fragis;
}
...
/*Reconstructs all coded fragments in a single MCU (one or two super block
  ...
  The token lists for each color plane and coefficient should also be filled
   ...
   counts.*/
static void oc_dec_frags_recon_mcu_plane(oc_dec_ctx* _dec, oc_dec_pipeline_state* _pipe, int _pli)
{
	unsigned char* dct_tokens;
	...
	for (fragii = 0; fragii < ncoded_fragis; fragii++)
	{
		...
		for (zzi = 0; zzi < 64;)
		{
			...
			else
			{
				...
				ti[zzi] = lti;
				zzi += rlen;
				_pipe->dct_coeffs[dct_fzig_zag[zzi]] = (ogg_int16_t)(coeff * (int)ac_quant[zzi]);
				zzi += !eob;
			}
		}
		...
		oc_state_frag_recon(&_dec->state, fragi, _pli, _pipe->dct_coeffs, last_zzi, dc_quant[qti]);
	}
	...
	if (_pipe->nuncoded_fragis[_pli] > 0)
	{
		...
		oc_frag_copy_list(&_dec->state, _dec->state.ref_frame_data[OC_FRAME_SELF],
						  _dec->state.ref_frame_data[OC_FRAME_PREV], _dec->state.ref_ystride[_pli],
						  _pipe->uncoded_fragis[_pli], _pipe->nuncoded_fragis[_pli], _dec->state.frag_buf_offs);
	}
}

/*Filter a horizontal block edge.*/
static void oc_filter_hedge(unsigned char* _dst, int _dst_ystride, const unsigned char* _src, int _src_ystride,
							int _qstep, int _flimit, int* _variance0, int* _variance1)
{
	unsigned char* rdst;
		...
		*_variance1 += OC_MINI(255, sum1);
		if (sum0 < _flimit && sum1 < _flimit && r[5] - r[4] < _qstep && r[4] - r[5] < _qstep)
		{
			...
			*cdst = (unsigned char)(r[0] * 2 + r[1] + r[2] * 2 + r[3] + r[4] + r[5] + 4 >> 3);
			...
			for (by = 0; by < 4; by++)
			{
				*cdst = (unsigned char)(r[by] + r[by + 1] + r[by + 2] + r[by + 3] * 2 + r[by + 4] + r[by + 5] +
											r[by + 6] + 4 >>
										3);
				cdst += _dst_ystride;
			}
...
static void oc_filter_vedge(unsigned char* _dst, int _dst_ystride, int _qstep, int _flimit, int* _variances)
{
	unsigned char* rdst;
	const unsigned char* rsrc;
	unsigned char* cdst;
	...
	for (by = 0; by < 8; by++)
	{
		...
		if (sum0 < _flimit && sum1 < _flimit && r[5] - r[4] < _qstep && r[4] - r[5] < _qstep)
		{
			...
			*rdst++ = (unsigned char)(r[0] * 2 + r[1] + r[2] * 2 + r[3] + r[4] + r[5] + 4 >> 3);
			for (bx = 0; bx < 4; bx++)
			{
				*rdst++ = (unsigned char)(r[bx] + r[bx + 1] + r[bx + 2] + r[bx + 3] * 2 + r[bx + 4] + r[bx + 5] +
											  r[bx + 6] + 4 >>
										  3);
			}
...
static void oc_dec_deblock_frag_rows(oc_dec_ctx* _dec, th_img_plane* _dst, th_img_plane* _src, int _pli, int _fragy0,
									 int _fragy_end)
{
	...
	for (; y < y_end; y += 8)
	{
		...
		flimit = (qstep * 3) >> 2;
		oc_filter_hedge(dst, dst_ystride, src - src_ystride, src_ystride, qstep, flimit, variance, variance + nhfrags);
		variance++;
		dc_qi++;
		for (x = 8; x < width; x += 8)
		{
			qstep = _dec->pp_dc_scale[*dc_qi];
			flimit = (qstep * 3) >> 2;
			oc_filter_hedge(dst + x, dst_ystride, src + x - src_ystride, src_ystride, qstep, flimit, variance,
							variance + nhfrags);
			oc_filter_vedge(dst + x - (dst_ystride << 2) - 4, dst_ystride, qstep, flimit, variance - 1);
			variance++;
			dc_qi++;
		}
		dst += dst_ystride << 3;
	...
	if (!notdone)
	{
		...
		for (x = 8; x < width; x += 8)
		{
			qstep = _dec->pp_dc_scale[*dc_qi++];
			flimit = (qstep * 3) >> 2;
			oc_filter_vedge(dst + x - (dst_ystride << 3) - 4, dst_ystride, qstep, flimit, variance++);
		}
	}
}

static void oc_dering_block(unsigned char* _idata, int _ystride, int _b, int _dc_scale, int _sharp_mod, int _strong)
{
...
static void oc_dec_dering_frag_rows(oc_dec_ctx* _dec, th_img_plane* _img, int _pli, int _fragy0, int _fragy_end)
{
	th_img_plane* iplane;
	oc_fragment_plane* fplane;
	oc_fragment* frag;
	...
	for (; y < y_end; y += 8)
	{
		for (x = 0; x < width; x += 8)
		{
			...
			{
				oc_dering_block(idata + x, ystride, b, _dec->pp_dc_scale[qi], _dec->pp_sharp_mod[qi], 1);
			...
			{
				oc_dering_block(idata + x, ystride, b, _dec->pp_dc_scale[qi], _dec->pp_sharp_mod[qi], 0);
			}
			frag++;
			variance++;
		}
	...
	switch (_req)
	{
		...
		case TH_DECCTL_SET_GRANPOS:
		{
			...
			_dec->state.curframe_num =
				_dec->state.keyframe_num + (granpos & (1 << _dec->state.info.keyframe_granule_shift) - 1);
			return 0;
		}
		break;
...
static void oc_dec_init_dummy_frame(th_dec_ctx* _dec)
{
	...
	_dec->state.ref_frame_data[OC_FRAME_GOLD] = _dec->state.ref_frame_data[OC_FRAME_PREV] =
		_dec->state.ref_frame_data[OC_FRAME_SELF] = _dec->state.ref_frame_bufs[0][0].data;
	memcpy(_dec->pp_frame_buf, _dec->state.ref_frame_bufs[0], sizeof(_dec->pp_frame_buf[0]) * 3);
...
#if defined(HAVE_CAIRO)
static void oc_render_telemetry(th_dec_ctx* _dec, th_ycbcr_buffer _ycbcr, int _telemetry)
{
	...
	if (_dec->telemetry_frame_data == NULL)
	{
		_dec->telemetry_frame_data =
			_ogg_malloc((w * h + 2 * (w >> hdec) * (h >> vdec)) * sizeof(*_dec->telemetry_frame_data));
		if (_dec->telemetry_frame_data == NULL)
			return;
	}
	...
	/*Draw coded identifier for each macroblock (stored in Hilbert order).*/
	{
		...
		if (_dec->telemetry_bits)
		{
			...
			if (_dec->telemetry_frame_bytes < 0 || _dec->telemetry_frame_bytes == OC_LOTS_OF_BITS)
			{
				_dec->telemetry_frame_bytes = 0;
			}
			if (_dec->telemetry_coding_bytes < 0 || _dec->telemetry_coding_bytes > _dec->telemetry_frame_bytes)
			{
				_dec->telemetry_coding_bytes = 0;
			}
			if (_dec->telemetry_mode_bytes < 0 || _dec->telemetry_mode_bytes > _dec->telemetry_frame_bytes)
			{
				_dec->telemetry_mode_bytes = 0;
			}
			if (_dec->telemetry_mv_bytes < 0 || _dec->telemetry_mv_bytes > _dec->telemetry_frame_bytes)
			{
				_dec->telemetry_mv_bytes = 0;
			}
			if (_dec->telemetry_qi_bytes < 0 || _dec->telemetry_qi_bytes > _dec->telemetry_frame_bytes)
			{
				_dec->telemetry_qi_bytes = 0;
			}
			if (_dec->telemetry_dc_bytes < 0 || _dec->telemetry_dc_bytes > _dec->telemetry_frame_bytes)
			{
		...
		case TH_PF_420:
		{
			for (y = 0; y < h; y += 2)
			{
				...
				for (x = 0; x < w; x += 2)
				{
					...
					int u;
					int v;
					y = (65481 * rgb_row[4 * x + 2] + 128553 * rgb_row[4 * x + 1] + 24966 * rgb_row[4 * x + 0] +
						 4207500) /
						255000;
					y_row[x] = OC_CLAMP255(y);
					y = (65481 * rgb_row[4 * x + 6] + 128553 * rgb_row[4 * x + 5] + 24966 * rgb_row[4 * x + 4] +
						 4207500) /
						255000;
					y_row[x + 1] = OC_CLAMP255(y);
					y = (65481 * rgb_row2[4 * x + 2] + 128553 * rgb_row2[4 * x + 1] + 24966 * rgb_row2[4 * x + 0] +
						 4207500) /
						255000;
					y_row2[x] = OC_CLAMP255(y);
					y = (65481 * rgb_row2[4 * x + 6] + 128553 * rgb_row2[4 * x + 5] + 24966 * rgb_row2[4 * x + 4] +
						 4207500) /
						255000;
					y_row2[x + 1] = OC_CLAMP255(y);
					u = (-8372 * (rgb_row[4 * x + 2] + rgb_row[4 * x + 6] + rgb_row2[4 * x + 2] + rgb_row2[4 * x + 6]) -
						 16436 * (rgb_row[4 * x + 1] + rgb_row[4 * x + 5] + rgb_row2[4 * x + 1] + rgb_row2[4 * x + 5]) +
						 24808 * (rgb_row[4 * x + 0] + rgb_row[4 * x + 4] + rgb_row2[4 * x + 0] + rgb_row2[4 * x + 4]) +
						 29032005) /
						225930;
					v = (39256 * (rgb_row[4 * x + 2] + rgb_row[4 * x + 6] + rgb_row2[4 * x + 2] + rgb_row2[4 * x + 6]) -
						 32872 * (rgb_row[4 * x + 1] + rgb_row[4 * x + 5] + rgb_row2[4 * x + 1] + rgb_row2[4 * x + 5]) -
						 6384 * (rgb_row[4 * x + 0] + rgb_row[4 * x + 4] + rgb_row2[4 * x + 0] + rgb_row2[4 * x + 4]) +
						 45940035) /
						357510;
			...
			for (y = 0; y < h; y++)
			{
				for (x = 0; x < w; x += 2)
				{
					...
					u = (-16744 * (rgb_row[4 * x + 2] + rgb_row[4 * x + 6]) -
						 ...
						 49616 * (rgb_row[4 * x + 0] + rgb_row[4 * x + 4]) + 29032005) /
						225930;
					v = (78512 * (rgb_row[4 * x + 2] + rgb_row[4 * x + 6]) -
						 65744 * (rgb_row[4 * x + 1] + rgb_row[4 * x + 5]) -
						 12768 * (rgb_row[4 * x + 0] + rgb_row[4 * x + 4]) + 45940035) /
						357510;
					u_row[x >> 1] = OC_CLAMP255(u);
					v_row[x >> 1] = OC_CLAMP255(v);
				}
			...
			for (y = 0; y < h; y++)
			{
				for (x = 0; x < w; x++)
				{
					...
					y = (65481 * rgb_row[4 * x + 2] + 128553 * rgb_row[4 * x + 1] + 24966 * rgb_row[4 * x + 0] +
						 4207500) /
						255000;
					u = (-33488 * rgb_row[4 * x + 2] - 65744 * rgb_row[4 * x + 1] + 99232 * rgb_row[4 * x + 0] +
						 29032005) /
						225930;
					v = (157024 * rgb_row[4 * x + 2] - 131488 * rgb_row[4 * x + 1] - 25536 * rgb_row[4 * x + 0] +
						 45940035) /
						357510;
					y_row[x] = OC_CLAMP255(y);
...
int th_decode_packetin(th_dec_ctx* _dec, const ogg_packet* _op, ogg_int64_t* _granpos)
{
	...
	if (_dec->state.frame_type != OC_INTRA_FRAME &&
		(_dec->state.ref_frame_idx[OC_FRAME_GOLD] < 0 || _dec->state.ref_frame_idx[OC_FRAME_PREV] < 0))
	{
	...
	if (_dec->state.ntotal_coded_fragis <= 0)
	{
		...
		_dec->state.granpos =
			(_dec->state.keyframe_num + _dec->state.granpos_bias << _dec->state.info.keyframe_granule_shift) +
	...
	else
	{
		...
		for (refi = 0;
			 refi == _dec->state.ref_frame_idx[OC_FRAME_GOLD] || refi == _dec->state.ref_frame_idx[OC_FRAME_PREV];
			 refi++)
			;
		_dec->state.ref_frame_idx[OC_FRAME_SELF] = refi;
		_dec->state.ref_frame_data[OC_FRAME_SELF] = _dec->state.ref_frame_bufs[refi][0].data;
#if defined(HAVE_CAIRO)
...
#if defined(HAVE_CAIRO)
			_dec->telemetry_coding_bytes = _dec->telemetry_mode_bytes = _dec->telemetry_mv_bytes =
				oc_pack_bytes_left(&_dec->opb);
#endif
		}
		else
		{
		...
		for (stripe_fragy = 0; notdone; stripe_fragy += _dec->pipe.mcu_nvfrags)
		{
			...
			for (pli = 0; pli < 3; pli++)
			{
				...
				_dec->pipe.fragy_end[pli] =
					OC_MINI(fplane->nvfrags, _dec->pipe.fragy0[pli] + (_dec->pipe.mcu_nvfrags >> frag_shift));
				...
				if (_dec->pipe.loop_filter)
				{
					sdelay += notstart;
					edelay += notdone;
					oc_state_loop_filter_frag_rows(&_dec->state, _dec->pipe.bounding_values, OC_FRAME_SELF, pli,
				...
				if (_dec->pipe.pp_level >= OC_PP_LEVEL_DEBLOCKY + pp_offset)
				{
					...
					sdelay += notstart;
					edelay += notdone;
					oc_dec_deblock_frag_rows(_dec, _dec->pp_frame_buf, _dec->state.ref_frame_bufs[refi], pli,
											 _dec->pipe.fragy0[pli] - sdelay, _dec->pipe.fragy_end[pli] - edelay);
					if (_dec->pipe.pp_level >= OC_PP_LEVEL_DERINGY + pp_offset)
					{
						...
						sdelay += notstart;
						edelay += notdone;
						oc_dec_dering_frag_rows(_dec, _dec->pp_frame_buf, pli, _dec->pipe.fragy0[pli] - sdelay,
												_dec->pipe.fragy_end[pli] - edelay);
					}
				}
				...
				avail_fragy_end = OC_MINI(avail_fragy_end, _dec->pipe.fragy_end[pli] - edelay << frag_shift);
			}
#ifdef HAVE_CAIRO
		...
		if (_dec->state.frame_type == OC_INTRA_FRAME)
		{
			...
			_dec->state.ref_frame_idx[OC_FRAME_GOLD] = _dec->state.ref_frame_idx[OC_FRAME_PREV] =
		...
		else
		{
			...
			_dec->state.ref_frame_idx[OC_FRAME_PREV] = _dec->state.ref_frame_idx[OC_FRAME_SELF];
			_dec->state.ref_frame_data[OC_FRAME_PREV] = _dec->state.ref_frame_data[OC_FRAME_SELF];
		}
		...
		if (telemetry)
		{
			...
			if (_dec->stripe_cb.stripe_decoded != NULL)
			{
				(*_dec->stripe_cb.stripe_decoded)(_dec->stripe_cb.ctx, stripe_buf, 0, _dec->state.fplanes[0].nvfrags);
			}
		}
#endif
#if defined(OC_DUMP_IMAGES)
